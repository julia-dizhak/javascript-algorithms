...
You probably already have an intuitive idea that binary search makes fewer 
guesses than linear search
...
Here at step there is only one subproblem a = 1, its size is a half of the initial 
problem b = 2,
