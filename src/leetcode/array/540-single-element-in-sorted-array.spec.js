...
describe('single in sorted array test case', () => {
  ...
  it('binary search solution', () => {
    ...
    expect(singleNonDuplicateBinarySearchOnEvenIndexes([1,1,2,3,3,4,4,8,8])).toEqual(2);
    expect(singleNonDuplicateBinarySearchOnEvenIndexes([3,3,7,7,10,11,11])).toEqual(10);
    expect(singleNonDuplicateBinarySearchOnEvenIndexes([1,1,2,2,3,3,4,4,5])).toEqual(5);
  });
