...
var findTheDifference = function(s, t) {
  ...
  const sSum = s.split('').map(char => char.charCodeAt(0) - 'a'.charCodeAt(0)).reduce((a,b) => a + b);
  // a b c d
  console.log('s', s.split(''));
  console.log('s', s.split('').map(char => char.charCodeAt(0) - 'a'.charCodeAt(0)));
  console.log('t', t.split('').map(char => char.charCodeAt(0) - 'a'.charCodeAt(0)));
  const tSum = t.split('').map(char => char.charCodeAt(0) - 'a'.charCodeAt(0)).reduce((a,b) => a + b);
